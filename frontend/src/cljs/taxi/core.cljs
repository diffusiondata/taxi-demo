...
;; The connection options for the Diffusion server
...
(def connection-options #js {:host (.-diffusionHost js/window)
                             :port (.-diffusionPort js/window)
                             :secure (.-diffusionSecure js/window)
                             :reconnect false
                             :principal (.-diffusionPrincipal js/window)
                             :credentials (.-diffusionCredential js/window)})
